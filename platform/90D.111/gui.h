...
#define BGMT_PRESS_UP 0x7c
#define BGMT_PRESS_DOWN 0x83
#define BGMT_PRESS_LEFT 0x80
#define BGMT_PRESS_RIGHT 0x7f
// Same unpress codes for up/down/left/right
#define BGMT_UNPRESS_UDLR 0x7b

#define BGMT_PRESS_SET 0x6
#define BGMT_UNPRESS_SET 0x7

#define BGMT_PLAY 0xe
// #define BGMT_UNPRESS_PLAY 0xf
#define BGMT_TRASH 0x10 // same if locked or unlocked, unlike 850D
#define BGMT_MENU 0x8
//#define BGMT_UNPRESS_MENU 0x9
#define BGMT_INFO 0xa
//#define BGMT_UNPRESS_INFO 0xb

#define BGMT_PRESS_DISP 0x10
#define BGMT_UNPRESS_DISP 0x11

#define BGMT_Q 0x26
#define BGMT_UNPRESS_Q 0x27
...
#define BGMT_PRESS_HALFSHUTTER 0xb0 // JC: not sure, could also be 99, 9d
//#define BGMT_UNPRESS_HALFSHUTTER 0xa4 // FIXME just this one button is defined in another file...
#define BGMT_PRESS_ZOOM_IN 0x45
#define BGMT_UNPRESS_ZOOM_IN 0x46
#define BGMT_PRESS_ZOOM_OUT 0x43 // when in Menu or Play, 0x98 on quick access menu
#define BGMT_UNPRESS_ZOOM_OUT 0x44 // When in Menu or Play, 0x99 on quick access menu
//#define BGMT_PICSTYLE 0x13
//#define BGMT_FUNC 0x12
//#define BGMT_JOY_CENTER 0x0 // wrong, avoiding conflicting definition

#define BGMT_LV 0x28
//#define BGMT_UNPRESS_LV 0x29

// wrong - avoiding conflicting definitions
#define BGMT_WHEEL_LEFT 0x9 
#define BGMT_WHEEL_RIGHT 0x10

#define BGMT_WHEEL_UP 0x0 // I bet this causes problems in our code with comparisons... // JC: wheel counterclockwise
#define BGMT_WHEEL_DOWN 0x1 // JC: wheel clockwise

// JC: ?? | ycommented out for now
//#define BGMT_FLASH_MOVIE 0x77
//#define BGMT_PRESS_FLASH_MOVIE 0x77
//#define BGMT_UNPRESS_FLASH_MOVIE 0x77


#define BGMT_ISO_MOVIE 0x4b
#define BGMT_PRESS_ISO_MOVIE 0x4b
#define BGMT_UNPRESS_ISO_MOVIE 0x4c

// JC: untouched after this point
